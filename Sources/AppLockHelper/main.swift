...
//  AppLockHelper
//
//  The AppLock background helper. Its job is to run the `LockEngine` when the
...
final class HelperAppDelegate: NSObject, NSApplicationDelegate {
    private static let mainAppBundleID = "gg.tame.applock"
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        observeMainApp()
        reconcile()
        Log.lifecycle.info("AppLock helper launched")
    }

...
//  AppLockCore
//
//  The complete, serialisable AppLock configuration: the global settings plus
...
/// The root persisted document for AppLock.
...
public enum ConfigurationError: Error, Equatable, Sendable {
    /// The document was written by a newer version of AppLock than this build
    /// understands.
